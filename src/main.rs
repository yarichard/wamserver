...
async fn main() {
    ...
    let api_router = Router::new()
        ...
        .route("/user/check-email", get(routes::services::check_email))
        .route("/user/{id}", axum::routing::put(routes::services::update_user).delete(routes::services::delete_user))
        .route("/user/{id}/password", axum::routing::patch(routes::services::change_user_password))
